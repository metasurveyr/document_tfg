...
-   **Directorio**: Un paquete en R debe estar contenido en un directorio que contenga al menos los siguientes archivos y directorios:
    ...
    -   [`man/`](<https://github.com/metaSurveyR/metasurvey/tree/main/man>): Directorio que contiene los archivos con la documentación de las funciones que se encuentran en el directorio `R/`. En general se utiliza *Roxygen2* [@roxygen] para generar la documentación de las funciones.
