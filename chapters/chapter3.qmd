...
-   `ech` [@detomasi2020] que permite la creación de variables referidas a Vivienda, Educación, Mercado de Trabajo, Ingresos y Pobreza.

-   `eph` [@kozlowski2020] que permite la descarga de datos de la EPH y la creación de variables para analizar la pobreza y el mercado de trabajo.

-   `svrep` [@schneider2023] que permite la estimación de varianzas en encuestas por muestreo.

-   `gustave` [@chevalier2023] que permite la estimación de varianzas en encuestas por muestreo.

-   `vardpoor` [@breidaks2020] que permite la estimación de varianzas en encuestas por muestreo.

-   `samplingVarEst` [@escobar2023] que permite la estimación de varianzas en encuestas por muestreo.
