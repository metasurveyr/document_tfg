...
\vspace*{.06\textheight}
\includegraphics[width=\textwidth]{images/logo.png} % University/department logo
{\scshape\LARGE \univname\par}\vspace{1.5cm} % University name
{\scshape\LARGE Facultad de Ciencias Económicas y de Administración\par}\vspace{1.5cm} % University name
...
\large \textbf{Trabajo final de grado presentado como requisito para la obtención del título \degreename}\\[0.3cm] % University requirement text
% \textit{in the}\\[0.4cm]
% \groupname\\
...
{\large Montevideo, Uruguay}\\[0.5cm] % Date

{\large Diciembre 2024}\\[0.5cm] % Date
...
\renewcaptionname{spanish}{\chaptername}{Capítulo}
...
\listoftables 
\addcontentsline{toc}{chapter}{Lista de Cuadros} % Agregar lista de tablas al índice

\listoflistings 
\addcontentsline{toc}{chapter}{Lista de Códigos} % Agregar lista de códigos al índice

\listoffigures
\addcontentsline{toc}{chapter}{Lista de Figuras} % Agregar lista de figuras al índice
